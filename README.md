...
Title = "thx for using our script"; 

Text = "by the Scripters bs"; -- what the text says (ofc) 
...
Text = "Subscribe to the Scripters"; -- what the text says (ofc) 
...
local Window = Library.CreateLib("night bedwars v2", "Ocean")

local Main = Window:NewTab("Main")
local MainSection = Main:NewSection("Main")

MainSection:NewKeybind("ui Toggle", "", Enum.KeyCode.F6, function()
	Library:ToggleUI()
end)

MainSection:NewLabel("this script is for all bedwars script")

MainSection:NewLabel("we don't know how to make a killAura or anything")

MainSection:NewLabel("jn hh gaming bedwars all script")

MainSection:NewButton("BJNv3", "", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JNHHGaming/JN-HH-Gaming-Pro/main/JN%20HH%20Gaming%20Pro",true))()
end)

MainSection:NewLabel("vape jn hh gaming script")

MainSection:NewButton("vapev4 jn hh gaming", "", function()
    loadstring(game:HttpGet("https://cdn.discordapp.com/attachments/1016359889246879802/1039822473933373510/Protected.lua",true))()
end)

MainSection:NewLabel("first jn hh gaming bedwars script killAura hydrogen")

MainSection:NewButton("first jn hh gaming killAura", "", function()
...
MainSection:NewLabel("darkrai x is only one bedwars script")

MainSection:NewButton("darkrai x bedwars", "", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/Darkrai-X/main/Games/Bedwars"))()
end)

MainSection:NewLabel("and script you may need")

MainSection:NewButton("inf jumps", "", function()
...
MainSection:NewLabel("vapev4 don't vape")

MainSection:NewButton("vapev4", "", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
end)

MainSection:NewLabel("animation scripts by jn hh gaming")

MainSection:NewButton("animation scripts", "", function()
    loadstring(game:HttpGet("https://cdn.discordapp.com/attachments/1016359889246879802/1039819753402941460/Protected.lua",true))()
end)

MainSection:NewLabel("Keyboard script")

MainSection:NewButton("Keyboard", "", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/main.txt", true))()
end)

MainSection:NewLabel("the end")

local Credits = Window:NewTab("Credits")

local CreditsSection = Credits:NewSection("Credits")

CreditsSection:NewLabel("by the Scripters bs")

CreditsSection:NewLabel("join the discord https://discord.gg/TbCYjPFf")

MainSection:NewLabel("op script")

MainSection:NewButton("cool script", "", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/bojoexploitz/yooo/main/itsobfuscated/InfinityHubTooOP", true))()
end)

MainSection:NewLabel("that's all the bedwars scripts for hydrogen I think")

local Fun = Window:NewTab("Fun")

local FunSection = Fun:NewSection("Fun")

FunSection:NewButton("Toy Animation","Opens Toy Animation",function() 
local Animate = 
...
FunSection:NewButton("Robot Animation","Plays Robot Animation",function() 
local Animate = 
game.Players.LocalPlayer.Character.Animate 
...
FunSection:NewButton("Zombie Animation" , "Plays Zombie Animation",function() 
loadstring(game:HttpGet("https://pastebin.com/raw/t3yTSPRn",true))() 
end)

FunSection:NewButton("Ninja Animation","Plays Ninja Animation",function() 
loadstring(game:HttpGet("https://pastebin.com/raw/bwGLPVV7",true))() 
end)

MainSection:NewButton("AutoToxic", "", function()
...
MainSection:NewToggle("Esp", "", function(state)
    if state then
...
MainSection:NewButton("AntiCheat Bypass", "", function()
...
MainSection:NewToggle("AntiVoid", "", function(state)
    if state then
...
MainSection:NewButton("Full Bright", "", function()
...
MainSection:NewButton("stop the Cape", "", function()
...
if lplr.Character.Humanoid.RigType == Enum.HumanoidRigType.R15 then
      ...
      CapeP.Color = Color3.fromRGB(255,1,10)
...
MainSection:NewButton("Cape(Purple)", "", function()
local player = game:GetService("Players")
